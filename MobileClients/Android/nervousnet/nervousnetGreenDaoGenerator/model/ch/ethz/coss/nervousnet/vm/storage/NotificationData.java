...
// KEEP INCLUDES END
/**
 * Entity mapped to table NOTIFICATION_DATA.
 */
public class NotificationData implements SensorDataImpl {
    ...
    public NotificationData(Long id, Long TimeStamp, String appName, long Volatility, Boolean ShareFlag) {
        this.id = id;
