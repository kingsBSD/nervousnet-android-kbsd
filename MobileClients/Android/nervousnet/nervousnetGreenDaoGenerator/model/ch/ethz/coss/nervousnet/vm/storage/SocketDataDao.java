...
/** 
 * DAO for table SOCKET_DATA.
*/
public class SocketDataDao extends AbstractDao<SocketData, Long> {

    public static final String TABLENAME = "SOCKET_DATA";

    /**
     * Properties of entity SocketData.<br/>
    ...
    */
    ...
    public SocketDataDao(DaoConfig config) {
        super(config);
    }
    
    public SocketDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SOCKET_DATA' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'SOCKET_DATA'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SocketData entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public SocketData readEntity(Cursor cursor, int offset) {
        SocketData entity = new SocketData( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, SocketData entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(SocketData entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(SocketData entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
